/* global chrome, getText, longToNormalAmount, sourceUrl, sourceUrl2, sourcePriceUrl, sourceOfflineMessages, sourceOfflineMessages2 */
...
chrome.alarms.onAlarm.addListener(() => {
  ...
  // checkPrice(sourcePrice, startup, false)
  xhrCall(source,
    () => {
